...
*/
console.log(`The character at index 0 is '${quote.charAt(0)}', The character at index 1 is '${quote.charAt(1)}', The character at index 2 is '${quote.charAt(2)}', The character at index 3 is '${quote.charAt(3)}', The character at index 4 is '${quote.charAt(4)}', The character at index 5 is '${quote.charAt(5)}',The character at index 6 is '${quote.charAt(6)}'`);
/*
...
console.log(quote.indexOf('o', indexOfFirst + 1));
/*
...
*/
let character15 = quote.padStart(15, '.');
console.log(character15);
/*
