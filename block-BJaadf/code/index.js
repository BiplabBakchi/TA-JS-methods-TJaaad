...
if (
    fruits[0] === 'Dragon Fruit' && fruits[1] === 'Guava'
) {
    console.log(true);
} else {
    console.log(false);
...
let doubleNumbers = function(num) {
    return num * 2;
};
numbersThree.map(doubleNumbers);
// Create a new variable named tripleNumbers that store the numberThree array (each element should be multiplied by 3). Use map
let tripleNumbers = function(num) {
    return num * 3;
};
numbersThree.map(tripleNumbers);
// Create a new variable named halfNumbers that store the numberThree array (each element should be divided by 2). Use map
let halfNumbers = function(num) {
    return num / 2;
};
numbersThree.map(halfNumbers);
// Create a new variable named oddNumbers that store all the odd numbers in numbersThree array
let oddNumbers =  function(num) {
    return num % 2 !== 0;
};
numbersThree.filter(oddNumbers);
// Create a new variable named evenNumbers that store all the even numbers in numbersThree array
let evenNumbers =  function(num) {
    return num % 2 === 0;
};
numbersThree.filter(evenNumbers);
// Find the index of 10 in numbersThree array
let equalTo10 = (num) => num === 10;
numbersThree.findIndex(equalTo10);
